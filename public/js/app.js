...
window.showLoadingModal = function(message, hideSpinner = false, autoCloseDelay = 0) {
 ...
 */
window.setMainGalleryImageFinal = function (src) {
 ...
 */
window.navigateToLocation = function(latitude, longitude, placeName) {
 ...
 */
window.toggleTimeInputs = function(checkbox, day) {
