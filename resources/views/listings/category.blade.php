...
@section('title', $currentCounty->name ?? ($currentCategory->name ?? 'Search Results') . ' - Discover Kenya')
...
@section(
    'meta_description',
    isset($currentCounty) && $currentCounty->slug && $currentCounty->slug !== 'search'
...
@section(
    'meta_keywords',
    isset($currentCounty) && $currentCounty->slug
