...
@section('title', 'Start a New Journey - Discover Kenya')
...
<style>
    ...
    .itinerary-form-header {
        ...
        margin-bottom: 50px;
        position: relative;
        display: block; /* Explicitly NOT sticky */
    }
...
<div class="itinerary-create-view">
    <div class="itinerary-main-container">
        <div class="itinerary-form-header">
            ...
            <h1 class="itinerary-main-title">Plan Your 2026</h1>
            <p class="itinerary-subtitle">Define the theme of your journey. You'll add specific stops next.</p>
        </div>

        <form action="{{ route('itineraries.store') }}" method="POST" class="itinerary-creation-form">
            @csrf
            
            <div class="form-group">
                <label class="form-label">Journey Title</label>
                <input type="text" name="title" class="form-input" placeholder="e.g. My Great Rift Valley Circuit" required>
            </div>

            <div class="form-group">
                <label class="form-label">Description (Optional)</label>
                <textarea name="description" class="form-input" rows="4" placeholder="What is this journey about?"></textarea>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="color-picker-grid">
                    ...
                    @endforeach
                    <input type="hidden" name="theme_color" id="theme_color_input" value="#3b82f6">
                </div>
            </div>
            ...
            <button type="submit" class="btn-submit">
                Create Journey <i class="fas fa-arrow-right ml-2"></i>
            </button>
        </form>
    </div>
</div>
