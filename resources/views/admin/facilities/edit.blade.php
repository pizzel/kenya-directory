                ...
                <div class="p-6 space-y-4">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="slug" value="{{ old('slug', $facility->slug) }}"
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all">
                        ...
                        <div>
                            ...
                            <div class="flex gap-2">
                                <div class="flex-1">
                                    <input type="text" name="icon_class" value="{{ old('icon_class', $facility->icon_class) }}"
                                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all"
                                        placeholder="e.g. fas fa-wifi">
                                </div>
                                <div class="w-10 h-10 rounded-lg bg-gray-100 flex items-center justify-center text-gray-600 border border-gray-200">
                                    <i class="{{ $facility->icon_class ?? 'fas fa-question' }}"></i>
                                </div>
                            </div>
